                ...
                <div class="row justify-content-around">
                    ...
                    <div class="col-9 my-3 text-center">
                        <h2>
                            <b>
                            <?php    
                            echo $personage->getHeroName() . ' VS ' . $ennemy->getOrcName();
                            ?>
                        </b>
                    </h2>
                        <?php
                        ...
                        <?php
                            ...
                            if ($personage->getHealth() > 0 && $ennemy->getHealth() > 0) {
                                echo '<b>Le combat Continue 🗡️</b>';
                                echo '</div></div>';
                            } else if ($personage->getHealth() <= 0) {
                                echo '<h3><b>' . $personage->getHeroName() . ' est mort de décès ⚰️</b></h3>';
                                echo '</div></div>';
                                break;
                            } else if ($ennemy->getHealth() <= 0) {
                                echo '<h3><b>' . $ennemy->getOrcName() . ' gis au sol tel un étron fumant ... CHEH ! ⚰️</b></h3>';
                                echo '</div></div>';
                                break;
                            }
                        }
